{{ config(
    ...
    rank_source_models = 'v_stg_c11_sales_item_status_vbup',
    cluster_by=["VBELN"]
    )
}}

{%- set source_model = "v_stg_c11_sales_item_status_vbup" -%}
{%- set src_pk = "SALES_ITEM_STATUS_HK" -%}
{%- set src_hashdiff = "SALES_ITEM_STATUS_HASHDIFF" -%}
{% set columns_query %}
