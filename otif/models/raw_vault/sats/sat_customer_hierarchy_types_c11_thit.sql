{{ config(
    ...
    rank_source_models = 'v_stg_c11_customer_hierarchy_types_thit'
    )
}}

{%- set source_model = "v_stg_c11_customer_hierarchy_types_thit" -%}
{%- set src_pk = "CUSTOMER_HIER_TYPES_HK" -%}
{%- set src_hashdiff = "CUSTOMER_HIER_TYPES_HASHDIFF" -%}
{% set columns_query %}
