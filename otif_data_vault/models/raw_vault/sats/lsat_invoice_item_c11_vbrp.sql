{{ config(
    ...
    rank_source_models = 'v_stg_c11_invoice_item_vbrp',
    cluster_by=["VBELN"]
    )
}}

{%- set source_model = "v_stg_c11_invoice_item_vbrp" -%}
{%- set src_pk = "INVOICE_ITEM_HK" -%}
{%- set src_hashdiff = "INVOICE_ITEM_HASHDIFF" -%}
{% set columns_query %}
