{% set table_metadata = { 
	 "table_definition":" 
		CREATE TABLE IF NOT EXISTS stage.sgm_allocated_data_rule_23 ( 
	...
	rsa_reconcile_bar_custno varchar(50)    ,
	rsa_reconcile_bar_division varchar(50)    ,
