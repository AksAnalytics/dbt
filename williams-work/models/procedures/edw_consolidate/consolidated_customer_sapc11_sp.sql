CREATE OR REPLACE PROCEDURE edw_consolidated.consolidated_customer_sapc11_sp()
	LANGUAGE plpgsql
AS $$
...
begin
    ...
    drop table if exists CONSOLIDATED_CUSTOMER_STG_SAPC11;
   
	CREATE TEMPORARY table CONSOLIDATED_CUSTOMER_STG_SAPC11 AS
	...
	using CONSOLIDATED_CUSTOMER_STG_SAPC11 customer_stg
	...
	select * from CONSOLIDATED_CUSTOMER_STG_SAPC11;
